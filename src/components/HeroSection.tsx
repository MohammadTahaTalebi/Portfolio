            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                <div className="flex flex-col md:flex-row lg:gap-16 gap-5 items-center">
                    ...
                    <div className="order-1 md:order-1 w-full md:w-1/2 text-center md:mb-0 mb-25 md:text-left relative">
                        <div className="absolute -top-10 -left-6 w-32 h-32 bg-purple-500/10 rounded-full blur-2xl z-0"></div>
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-wrap justify-center md:justify-start gap-3 mb-8">
                                {[
                                    ...
                                    <span
                                        key={index}
                                        className={`px-4 py-2 bg-gray-800/50 backdrop-blur-sm border border-gray-700/30 rounded-lg ${tech.color} font-medium`}
                                    >
                                        {tech.name}
                                    </span>
                                ))}
                            ...
                            <p className="text-xl text-gray-300 mb-10 leading-relaxed max-w-xl mx-auto md:mx-0">
                                I build{" "}
                                <span className="text-purple-400 font-medium">
                                    scalable applications
                                </span>{" "}
                                with modern technologies, focusing on{" "}
                                <span className="text-blue-400 font-medium">clean code</span> and{" "}
                            ...
                            <div className="flex flex-wrap justify-center md:justify-start gap-5 mb-12">
                                <button
                                    ...
                                    className="px-8 py-4 cursor-pointer bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 rounded-xl transition-all duration-300 flex items-center gap-3 shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 group"
                                >
                                ...
                                <button
                                    ...
                                    className="px-8 py-4 cursor-pointer border border-purple-500/40 hover:bg-purple-900/40 rounded-xl transition-all duration-300 backdrop-blur-sm hover:shadow-lg hover:shadow-purple-500/10"
                                >
                                    View Experiences
                                </button>
                            </div>
