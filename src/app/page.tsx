...
export default function Home() {
  ...
  return (
    <div className="min-h-screen lg:pt-10 md:pt-20 pt-30 bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 text-white">
      {/* Hero Section */}
      <HeroSection />
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-800/40 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-purple-500/30 transition-all duration-500">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: <SiPostgresql size={28} className="text-blue-400" />, name: 'PostgreSQL' },
                  { icon: <SiMongodb size={28} className="text-green-500" />, name: 'MongoDB' },
                  { icon: <SiGraphql size={28} className="text-pink-500" />, name: 'GraphQL' },
                ].map((skill, index) => (
                  <div key={index} className="flex items-center gap-3 p-3 bg-gray-700/30 rounded-lg">
                    {skill.icon}
                    <span>{skill.name}</span>
            ...
            <div className="bg-gray-800/40 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-orange-500/30 transition-all duration-500">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: <SiAwslambda size={28} className="text-orange-400" />, name: 'AWS' },
                  { icon: <SiJest size={28} className="text-red-400" />, name: 'Jest' },
                  { icon: <FiCpu className="text-cyan-400" size={28} />, name: 'CI/CD' },
                ].map((skill, index) => (
                  <div key={index} className="flex items-center gap-3 p-3 bg-gray-700/30 rounded-lg">
                    {skill.icon}
                    <span>{skill.name}</span>
            ...
            <div className="bg-gray-800/40 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-red-500/30 transition-all duration-500">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: <FiCode className="text-green-400" size={28} />, name: 'REST APIs' },
                  { icon: <FiDatabase className="text-yellow-400" size={28} />, name: 'SQL' },
                  { icon: <FiCpu className="text-purple-400" size={28} />, name: 'WebSockets' },
                  { icon: <FiLayers className="text-blue-300" size={28} />, name: 'Microservices' },
                ].map((skill, index) => (
                  <div key={index} className="flex items-center gap-3 p-3 bg-gray-700/30 rounded-lg">
                    {skill.icon}
                    <span>{skill.name}</span>
